			...
			<form>
               <table>
    			...
    			<tr>
      				...
      				<td align="left"><input type="text" name="dob" placeholder="MM/DD/YYYY" /></td>
    			</tr>
    			<tr>
    			...
    			<tr>
      				...
      				<td align="left"><input type="text" name="id" placeholder="Passport/License..." /></td>
    			</tr>
    			<tr>
    			...
    			<tr>
    				<td><button class="btn btn-success" type="button" name="submit" value="submit">Submit</button></td>
